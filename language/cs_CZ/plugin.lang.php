...
// | USA.                                                                  |
// +-----------------------------------------------------------------------+
$lang['<b>Warning:</b> all files will be deleted within %d hours'] = '<b>Upozornění:</b> všechny soubory budou odstraněnyběhem %d hodin';
$lang['Archive comment'] = 'Komentář archivu';
...
$lang['Remove from download set'] = 'Odstranit ze stažené sady';
$lang['Return to download page'] = 'Zpět na stránku stahování';
$lang['Set type'] = 'Nastavit typ';
$lang['The archive is downloading, if the download doesn\'t start automatically please <a href="%s">click here</a>'] = 'Archiv se nahrává, pokud nahrávání nezačne automaticky, prosím  <a href="%s">stiskněte zde</a>';
$lang['Total size'] = 'Celková velikost';
$lang['User collection'] = 'Uživatelský výběr';
...
$lang['%s lines printed, %s in total.'] = '%s řádek zobrazeno z celkových 